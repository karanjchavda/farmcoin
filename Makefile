...
pkgdatadir = $(datadir)/farmcoin
pkgincludedir = $(includedir)/farmcoin
pkglibdir = $(libdir)/farmcoin
pkglibexecdir = $(libexecdir)/farmcoin
...
ACLOCAL = ${SHELL} /farmcoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /farmcoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /farmcoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /farmcoin/build-aux/missing automake-1.15
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = farmcoin-cli
BITCOIN_DAEMON_NAME = farmcoind
BITCOIN_GUI_NAME = farmcoin-qt
BITCOIN_TX_NAME = farmcoin-tx
...
COPYRIGHT_HOLDERS_FINAL = The Farmcoin Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = Farmcoin Core
COPYRIGHT_YEAR = 2017
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /farmcoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = farmcoin
PACKAGE_BUGREPORT = https://github.com/farmcoin-project/farmcoin/issues
PACKAGE_NAME = Farmcoin Core
PACKAGE_STRING = Farmcoin Core 0.15.0
PACKAGE_TARNAME = farmcoin
PACKAGE_URL = https://farmcoin.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /farmcoin
abs_srcdir = /farmcoin
abs_top_builddir = /farmcoin
abs_top_srcdir = /farmcoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /farmcoin/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/Farmcoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/Farmcoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Farmcoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Farmcoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
