...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s farmcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  farmcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded farmcoin transaction") + "\n" +
              "  farmcoin-tx [options] -create [commands]   " + _("Create hex-encoded farmcoin transaction") + "\n" +
              "\n";
