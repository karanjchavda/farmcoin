...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/farmcoin-project/farmcoin>";
    const std::string URL_WEBSITE = "<https://farmcoin.org>";
